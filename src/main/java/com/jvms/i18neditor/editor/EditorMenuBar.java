...
public class EditorMenuBar extends JMenuBar {
	...
	private void setupUI() {
		...
		createPropertiesMenuItem
				.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, keyMask + KeyEvent.SHIFT_DOWN_MASK));
		...
		saveMenuItem = new JMenuItem(MessageBundle.get("menu.file.save.title"),
				MessageBundle.getMnemonic("menu.file.save.vk"));
		...
		reloadMenuItem = new JMenuItem(MessageBundle.get("menu.file.reload.title"),
				MessageBundle.getMnemonic("menu.file.reload.vk"));
		reloadMenuItem.addActionListener(e -> editor.reloadProject());

		JMenuItem exitMenuItem = new JMenuItem(MessageBundle.get("menu.file.exit.title"),
				MessageBundle.getMnemonic("menu.file.exit.vk"));
		...
		editorSettingsMenuItem.addActionListener(e -> {
			Dialogs.showComponentDialog(editor, MessageBundle.get("dialogs.preferences.editor.title"),
		...
		projectSettingsMenuItem.addActionListener(e -> {
			Dialogs.showComponentDialog(editor, MessageBundle.get("dialogs.preferences.project.title"),
